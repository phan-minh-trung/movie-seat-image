...
RUN apt-get update && apt-get install -y python-software-properties software-properties-common \
  ...
  && apt-get update \
  && apt-get install -y nginx php7.0 php7.0-fpm php7.0-cli php7.0-common libapache2-mod-php7.0 php7.0 php7.0-mysql php7.0-fpm php7.0-curl php7.0-gd php7.0-bz2 supervisor \
